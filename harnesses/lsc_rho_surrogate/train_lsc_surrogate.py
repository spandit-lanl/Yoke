...
descr_str = ('Trains Transpose-CNN to reconstruct density field of LSC simulation '
             'from contours and simulation time.')
...
parser.add_argument('--kernel',
                    ...
                    nargs=2,
                    default=[3, 3],
                    help='Size of T-conv kernel.')

parser.add_argument('--featureList',
                    action='store',
                    type=int,
                    nargs='+',
                    default=[512, 512, 512, 512, 256, 128, 64, 32],
...
parser.add_argument('--linearFeatures',
                    ...
                    nargs=2,
                    default=[4, 4],
                    help='Size of each layer scalar inputs are mapped into prior to T-convs.')
...
if __name__ == '__main__':
    ...
    linearFeatures = tuple(args.linearFeatures)
