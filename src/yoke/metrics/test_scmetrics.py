...
if __name__ == "__main__":
    ...
    fid = open(outfile, "w")
    fid.write(
        "key, time_index, eff_jet_mass_percent, jet_mass, HE_mass, avg_width_1, std_width_1, max_width_1, KE_2D, sqrt_KE_2D\n"
    )
        ...
        for itime, time_index in enumerate(time_list):
            ...
            fid.write(
                ...
                % (
                    ifile,
                    time_index,
                    eff_jet_mass[irun, itime],
                    jet_mass[irun, itime],
                    HE_mass[irun, itime],
                    jet_width_avg[irun, itime],
                    jet_width_std[irun, itime],
                    jet_width_max[irun, itime],
                    KE[irun, itime],
                    sqrt_KE[irun, itime],
                )
            )
