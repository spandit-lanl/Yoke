...
class hybrid2vectorCNN(nn.Module):
    ...
    Args:
        ...
        kernel (tuple[int, int]): Size of convolutional kernels
    ...
    def __init__(
        ...
        self.lin_embed_features = lin_embed_features
        ...
        self.lin_embed_h1 = generalMLP(
            ...
            output_dim=self.lin_embed_features,
            hidden_feature_list=[2 * self.lin_embed_features],
            act_layer=nn.GELU,
        ...
        # Final MLP
        #
        # NOTE: Final activation should somehow be changed to identity.
        cat_size = self.vector_embed_dim + 2 * self.lin_embed_features
...
if __name__ == "__main__":
    ...
    # pred_y, pred_H1, pred_H2 = value_pred

    # print("pred_y shape:", pred_y.shape)
    # print("pred_H1 shape:", pred_H1.shape)
    # print("pred_H2 shape:", pred_H2.shape)
