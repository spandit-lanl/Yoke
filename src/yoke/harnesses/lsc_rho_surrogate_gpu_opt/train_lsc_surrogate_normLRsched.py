...
from yoke.datasets.lsc_dataset import LSCnorm_cntr2rho_DataSet
...
if __name__ == '__main__':
    ...
    ## Initialize Data
    #############################################
    train_dataset = LSCnorm_cntr2rho_DataSet(LSC_NPZ_DIR,
                                             train_filelist,
                                             design_file,
                                             normalization_file)
    val_dataset = LSCnorm_cntr2rho_DataSet(LSC_NPZ_DIR,
                                           validation_filelist,
                                           design_file,
                                           normalization_file)
    test_dataset = LSCnorm_cntr2rho_DataSet(LSC_NPZ_DIR,
                                            test_filelist,
                                            design_file,
                                            normalization_file)
